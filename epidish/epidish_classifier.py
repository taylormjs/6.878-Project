...
def load_epidish_results(study="martino2015"):
  ...
  coe_control = pd.read_csv("../analysis/{}_coe_control.csv".format(study), index_col=0)
  coe_change = pd.read_csv("../analysis/{}_coe_change.csv".format(study), index_col=0)
  cell_frac = pd.read_csv("../analysis/{}_cellfrac.csv".format(study), index_col=0)
  pheno = pd.read_csv("../analysis/{}_phenotypes.csv".format(study), index_col=0)
  beta = pd.read_csv("../analysis/{}_beta.csv".format(study), index_col=0)
